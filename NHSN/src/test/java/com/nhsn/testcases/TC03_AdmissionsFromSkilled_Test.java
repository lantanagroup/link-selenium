...
public class TC03_AdmissionsFromSkilled_Test extends BaseClass {
    LoginPage lPage;
    HomePage hPage;
    ...
    public void generateCovidReport() throws InterruptedException {
        ...
        try
        {
            ...
            hPage.generateReport("Admissions from Skilled Nursing Facility to Hospital COVID-19 Reporting");
        }
        catch(Exception e)
        {
